...
const PlaylistAddModal = (props) => {
  ...
  let filteredPlaylists = props.playlist.filter((playlist) => {
    if (playlist.owner.id === props.current_user.userInfo.id) {
      return playlist;
    }
  });
  ...
  return (
    <div className={style[props.showModal ? "container" : "inactive"]}>
      <div
        ...
        className={style["container-mask"]}
      ></div>
      <div className={style["modal-container"]}>
              ...
              <div className={style["playlist-item-container"]}>
                <div className={style["playlist-item"]}>
                  <div className={style["check-index-container"]}>
                    ...
                    <CheckIconPlaceH
                      style={{
                        display: selectedPlaylists.length > 0 ? "flex" : "none",
                      }}
        ...
        <div className={style["button-container"]}>
          <button onClick={props.closeModal} className={style["cancel-button"]}>
            Cancel
          </button>
          <button
            onClick={() => handleAdd()}
